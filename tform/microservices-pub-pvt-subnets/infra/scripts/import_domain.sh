...
terraform import aws_route53_zone.primary XXXX 
terraform import aws_route53_record.primary XXXX_YYYY_ZZZ
terraform import aws_route53_record.primary_with_www XXXX_YYYY_ZZZ